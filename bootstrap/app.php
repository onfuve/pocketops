...
use App\Http\Controllers\InstanceSyncExportController;
use App\Http\Middleware\VerifyInstanceSyncBearer;
...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        health: '/up',
        then: function (): void {
            Route::get('/instance-sync/export', [InstanceSyncExportController::class, 'export'])
                ->middleware(VerifyInstanceSyncBearer::class);
        },
    )
